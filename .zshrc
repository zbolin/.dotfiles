...
alias gen='f() { mvn archetype:generate -DgroupId=com.z.$1 -DartifactId=$1 -DarchetypeArtifactId=maven-archetype-quickstart -DarchetypeVersion=1.4 -DinteractiveMode=false  };f'
